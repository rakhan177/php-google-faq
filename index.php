<?php
  $array = [
    ...
    [
      ...
      'risposte' => "<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
    ...
    [
      ...
      'risposte' => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
    ...
    <div class="container">
      ...
      <main class="main">
        ...
        <?php foreach ($array as $val) { ?>
          <h2 class="main-content-domande"><?php echo $val["domande"]; ?></h2>
          <div class="main-content-risposte"><?php echo $val["risposte"]; ?></div>
        <?php } ?>
        </div>
      </main>
      <footer class="footer">
        <div class="footer-content">
          ...
          <div class="footer-content-right">
            <div>
              <input type="text" name="" placeholder="Italiano" value="">
            </div>
          </div>
        </div>
      </footer>
